...
class AutoGeneratePipelineRank:
    ...
    def generate_pipeline(self):
        ...
        for i in range(self.pipeline_numbers):
            ...
            self.up_pipline_list.append(MyPipeLine(pipeline_id=i,
                                                   micro_batch_numbers=micro_num, 
                                                   stage_numbers=self.stage_numbers,
                                                   pipeline_numbers=self.pipeline_numbers, 
                                                   module_to_stage_map=self.module_to_stage_map, 
                                                   up_or_down=True))
            ...
            self.down_pipeline_list.append(MyPipeLine(pipeline_id=i,
                                                      micro_batch_numbers=micro_num, 
                                                      stage_numbers=self.stage_numbers,
                                                      pipeline_numbers=self.pipeline_numbers, 
                                                      module_to_stage_map=self.module_to_stage_map, 
